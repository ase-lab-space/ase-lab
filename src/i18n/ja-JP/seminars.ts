export default {
  ...
  seminar46: {
    name: 'Autowareゼミ',
    discription:
      'Autowareを用いた自律走行の原理を理解する勉強会です！今後はROSを用いてAutowareの自律走行を実装するゼミを立てようと思っています！よかったらぜひご参加ください！',
    span: '週1回',
  },
  seminar45: {
    name: '自動車 / ローバー(構造)ゼミ',
    discription:
      'ローバーや車の機構や構造の勉強会です！複数の教材の中から自動車やローバーの機構部分に注目したゼミです！興味がある方は, 是非ご参加ください！！',
    span: '週1回',
  },
  seminar44: {
    name: '宇宙機・航空機・ロケットなんでも紹介ゼミ',
    discription:
      '好きな航空宇宙系のミッションや機体についてプレゼンしてもらうめちゃくちゃ緩めのゼミです！ぜひご参加ください！聞く専の人も大歓迎です!',
    span: '隔週',
  },
  seminar43: {
    name: '宇宙資源ゼミ',
    discription:
      '宇宙資源は理学的にも工学的にも面白い話題が多く今ホットな分野なので、参加メンバーの興味に合わせて宇宙資源をいろんな観点から勉強し、最終的には講演イベントの開催や学園祭の出展などのアウトプットまで妄想を広げている段階です',
    span: '週1回',
  },
  seminar42: {
    name: '宇宙ビジネスゼミ_アストロキャンプ',
    discription:
      '宇宙ビジネスのを基礎から学び、特定の分野を深堀して学習していくことで宇宙ビジネスについての理解を深めます。さらに宇宙ビジネスをモデルとしたファイナンスなどの実践的な学習を経て、自ら考えた宇宙ビジネスに対し',
    span: '隔週',
  },
  seminar41: {
    name: 'ミッション設計ゼミ_アストロキャンプ',
    discription:
      '「ミッション解析と軌道設計の基礎」など，宇宙工学に関する本を読んで実際のミッションを参考にどのようにミッションっ設計が行われるかを学びます',
    span: '週1,2回',
  },
  seminar40: {
    name: '自動運転ゼミ_アストロキャンプ',
    discription:
      '惑星探査をはじめ，様々な産業で活躍されている自動運転の技術の理論やROSの基礎を学び、Autowareを使った自動運転のシミュレーションを実装します',
    span: '2月下旬～3月下旬',
  },
  seminar39: {
    name: '宇宙流体力学ゼミ_アストロキャンプ',
    discription:
      'zoomで行う事前学習では流体力学や宇宙流体力学の基礎について学び対面で行うアストロキャンプでは複数のチームに分かれて、それぞれ別々の天体現象などについて学び、理解を深めます。',
    span: '週1～3回',
  },
  seminar38: {
    name: '宇宙論ゼミ',
  ...
  seminar30: {
    name: '電子工作入門ゼミ',
    discription:
      '電子工作は缶サット，人工衛星，ロケットの電装，ロボットなどなどに必須の知識です．この機会に手を動かしながら学んでみませんか？？',
    span: '週１回',
  },
  seminar29: {
    name: '惑星科学ゼミ',
